    ...
    <div className="relative isolate h-[calc(100vh-80px)] overflow-hidden px-3 pb-0">
      <section className="mx-auto mt-1 flex h-full max-w-[108rem] flex-col overflow-hidden rounded-3xl border border-white/60 bg-white/70 p-3 shadow-lg backdrop-blur dark:border-white/10 dark:bg-slate-900/80">
        <div className="mb-3 flex items-center justify-between gap-3 px-1">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">结算工作台</p>
            <h1 className="mt-1 text-2xl font-semibold text-slate-900 dark:text-white">结算&Agent</h1>
          </div>
        </div>

        <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-2 gap-4 lg:grid-cols-[1fr_1.18fr] lg:grid-rows-1">
          ...
          <div className="flex h-full min-h-0">
            <AgentConsole mode="user" layout="panel" />
          </div>
        </div>
      </section>
    </div>
